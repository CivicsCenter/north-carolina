...
CREATE OR REPLACE TABLE `nc_production.20250823_scorecard_nc` AS
...
FROM `tcc-research.nc_sources.20250823_nc_voter_registration_and_history` a LEFT JOIN county_fips_map b ON a.county_desc = b.COUNTY_NAME
